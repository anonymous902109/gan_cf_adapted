...
from src.util import restrict_tf_memory, load_baselines_model


class Solver(object):
    """Solver for training and testing StarGAN."""

    def __init__(self, celeba_loader, rafd_loader, discrete_loader=None, config=None):
        """Initialize configurations."""

        # Data loader.
        self.celeba_loader = celeba_loader
        self.rafd_loader = rafd_loader
        self.discrete_loader = discrete_loader
        ...
        if config.agent_path is None:
            ...
            self.pacman = False
            self.agent = DQN.load(config.agent_path)
    ...
    def build_model(self):
        ...
        if self.dataset in ['CelebA', 'RaFD', 'Discrete']:
    ...
    def create_labels(self, c_org, c_dim=5, dataset='CelebA', selected_attrs=None):
        ...
        for i in range(c_dim):
            ...
            elif dataset == 'RaFD' or dataset == 'Discrete':
    ...
    def train(self):
        ...
        if self.env_type == 'Discrete':
            data_loader = self.discrete_loader
        ...
        for i in range(start_iters, self.num_iters):
            ...
            elif self.dataset == 'RaFD' or self.dataset == 'Discrete':
